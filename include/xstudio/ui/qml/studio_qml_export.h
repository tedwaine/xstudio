...
#      define STUDIO_QML_EXPORT __attribute__((visibility("default")))
#    else
...
#    define STUDIO_QML_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef STUDIO_QML_DEPRECATED
#  define STUDIO_QML_DEPRECATED __attribute__ ((__deprecated__))
#endif

...
#      define HELPER_QML_EXPORT __attribute__((visibility("default")))
#    else
...
#    define HELPER_QML_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef HELPER_QML_DEPRECATED
#  define HELPER_QML_DEPRECATED __attribute__ ((__deprecated__))
#endif

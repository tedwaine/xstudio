...
macro(create_component_with_alias NAME ALIASNAME VERSION DEPS)
	...
	file(GLOB SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/*.mm ${CMAKE_CURRENT_SOURCE_DIR}/*.cpp ${CMAKE_CURRENT_SOURCE_DIR}/*.proto)
...
macro(create_qml_component_with_alias NAME ALIASNAME VERSION DEPS EXTRAMOC)
	...
	if (${XSTUDIO_GRAPHICS_API} STREQUAL "Metal")
		file(GLOB MMSOURCES ${CMAKE_CURRENT_SOURCE_DIR}/*.mm)
		list(APPEND SOURCES ${MMSOURCES})
	endif()

        ...
        RowLayout{
            ...
            XsText{
                ...
                XsModelProperty {
                    id: playheadTimecode
                    role: "value"
                    index: currentPlayheadData.searchRecursive("Current Source Timecode", "title")
                }

                Connections {
                    target: currentPlayheadData // this bubbles up from XsSessionWindow
                    function onJsonChanged() {
                        playheadTimecode.index = currentPlayheadData.searchRecursive("Current Source Timecode", "title")
                    }
                }
            ...
            XsText{ id: titleDiv
                ...
                Layout.preferredHeight: parent.height
                text: viewedMediaSetProperties.values.nameRole ? viewedMediaSetProperties.values.nameRole : ""
                font.bold: true
